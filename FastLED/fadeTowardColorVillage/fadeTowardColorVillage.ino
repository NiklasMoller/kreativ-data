...
void loop()
{
  ...
  //Serial.println("LOOPING over LEDS");
}
...
void ChangePalettePeriodically()
{
  ...
  if( lastSecond != secondHand) {
    ...
    //if( secondHand == 0)  { targetPalette = CRGBPalette16( g,g,b,b, p,p,b,b, g,g,b,b, p,p,b,b); }
    //if( secondHand == 0)  { targetPalette = CRGBPalette16( b,b,b,w, b,b,b,w, b,b,b,w, b,b,b,w); }
    if( secondHand == 0)  { targetPalette = ForestColors_p; }
